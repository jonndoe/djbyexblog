...
class OwnerPostMixin(OwnerMixin, LoginRequiredMixin):
    ...
    success_url = reverse_lazy('post:manage_course_list')
        ...
        if form.is_valid():
            ...
            if not id:
                ...
                Content.objects.create(post=self.postobj,
                                       item=obj)
            return redirect('post:post_content_list', self.postobj.id)
...
class ContentDeleteView(View):
    ...
    def post(self, request, id):
        ...
        content.item.delete()
        content.delete()
        return redirect('post:post_content_list', postobj.id)
